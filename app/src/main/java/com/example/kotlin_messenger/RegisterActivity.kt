...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        register_edittext.setOnClickListener {
            performRegister()
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 0 && resultCode == Activity.RESULT_OK && data != null){
            ...
            //selectphoto_button.setBackground(bitmapDrawable)
        }
    }
    ...
    private fun uploadImageToFirebaseStorage(){
        ...
        ref.putFile(selectedPhotoUri!!)
            ...
            .addOnFailureListener {
                Log.d("RegisterActivity","Failed to upload to image to storage")
            }
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String){
        ...
        ref.setValue(user)
            ...
            .addOnFailureListener {
                Log.d("RegisterActivity","Failed to set value to databcae: ${it.message}")
            }
    }
